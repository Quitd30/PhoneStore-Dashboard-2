...
namespace PhoneStore.Models
{
    public partial class WarrantyClaim
    {
        ...
        [Required]
        [StringLength(50)]
        public string ClaimCode { get; set; } = null!; // Mã yêu cầu bảo hành

        [Required]
        [StringLength(500)]
        public string IssueDescription { get; set; } = null!; // Mô tả vấn đề

        [StringLength(20)]
        public string IssueType { get; set; } = ClaimIssueType.Hardware; // Loại lỗi

        [StringLength(20)]
        public string Status { get; set; } = ClaimStatus.Pending; // Trạng thái yêu cầu
        ...
        [StringLength(20)]
        public string? ResolutionType { get; set; } // Loại giải quyết

        public DateTime SubmittedDate { get; set; } = DateTime.Now; // Ngày gửi yêu cầu
        ...
        [StringLength(100)]
        public string? ProcessedByAdmin { get; set; } // Admin xử lý
